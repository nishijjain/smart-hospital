...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div align="center">
		<br>
		<p>Not registered yet? <a target="_blank" style="font-colour="Blue"" href='registration.php'>Register Here</a></p>
	</div>
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br> Welcome to your Login Page! Enter login details to use facilities of a Basic Admin.<br><br> To gain access to Super Admin Login, click on: <a target="_blank" style="font-colour="Blue"" href='superadmin.php'>Super Admin Login</a>
<br>
	<br></div>
	</div>
