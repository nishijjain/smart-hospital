...
<title>Chettinad Hospital</title>
...
<body style="background-image: url(hithu.jpg);">
...
<h1 class="text-center ">Chettinad Hospital<br /><small style="font-size:20px">Hospital Management System</small></h1></div>
...
<li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staff.php"><strong>Add Staff Member</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffmemd.php"><strong> Details of Staff Members</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="sestaffactmem.php"><strong>Search for Staff Members</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffactmem.php"><strong>Active Members</strong></a></li>
<li id="lock" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmst.php"><strong>Staff Member Modifications</strong></a></li>
</ul>
</div></div>
<div class="container">
<div class="row">
...
<h3 style="font-family:calibri;" class="text-center">Staff Member Registration</h3></div>
<br />
...
<div class="panel-footer text-center">Press Submit button after completing the form </div>
</div>
</div>
</div>
</div>
