...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="basiadminopts.php"><strong>Insert New Basic Admins</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesbsad.php"><strong>Delete Basic Admins</strong></a></li>
</ul>
<hr>
</div></div>
...
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">This user registration form only creates accounts for Receptionists</div></div>
<div class="container">
<div class="row">
...
document.write('<?php echo $regs; ?>');</script> </center>
  ...
  <div class="panel-footer text-center">Press Submit button after filling in the details.</div>
</div>
