...
<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>Welcome to the Top Level Admin login form. Enter correct credentials to access the system </div>
	</div>
	</div>
	<br>
