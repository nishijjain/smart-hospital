...
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">This form is used to create accounts for Receptions, who only have the authority to insert.</div></div>
<div class="container">
<div class="row">
...
<tr><td colspan="2" style="padding:5px;">
  ...
  <input name="ucpw"  required="required" style="border-radius:0px" type="password" class="form-control" placeholder="Confirm Password"><center><script type="text/javascript">
