...
<h3 style="font-family:calibri;" class="text-center">Admitted Patients Information</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">Click on Discharge to discharge the patient</h4>
<br />
<table style="background-color:#FFF; font-size:12px; " class="table table-striped table-hover table-bordered">
<thead>
<tr>
<th><strong>S.No</strong></th>
<th><strong>Admit No.</strong></th>
<th><strong>Patient No.</strong></th>
<th><strong>Admitted Date</strong></th>
...
<th><strong>Patient Disease</strong></th>
