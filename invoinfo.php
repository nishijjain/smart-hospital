...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoinfo.php"><strong>All OPD Patients Invoices</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="invoadinfo.php"><strong>All Admited Patients Invoices</strong></a></li>
...
<h3 style="font-family:calibri;" class="text-center">All OPD Patients Invoices</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">Click on View to print or view the patient's info.</h4>
<br />
...
<th><strong>Doctor Incharge</strong></th>
<th><strong>Medicine Charge</strong></th>
