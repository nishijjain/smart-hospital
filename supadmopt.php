...
Welcome to the top level administration page! <?php echo $_SESSION['topadun']; ?>  <a href="dminlogout.php">Logout</a>
</div>
<br>
<br><br />
<div class="container">
...
<h1 class="text-center ">Chettinad Hospital<br /><small style="font-size:20px">Hospital Management System</small></h1>
</div>
</div>
</div>
<br /><br />
...
<ul class="nav  nav-justified" style="background-color:#FFF;">
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadmopt.php"><strong>Insert New Super Admins</strong></a></li>
  <li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="deletesupad.php"><strong>Delete Super Admins</strong></a></li>
</ul>
<hr>
</div></div>
<?php
...
<div class="alert alert-danger col-md-4 col-md-offset-4 col-xs-12 text-center">This user registration form creates Super Admin accounts.</div></div>
<div class="container">
<div class="row">
<div class="col-md-4 col-md-offset-4 col-xs-12">
<div class="panel panel-default">
<div class="panel-heading text-center">Super Admin Registration Form</div>
...
document.write('<?php echo $regs; ?>');</script> </center>
  ...
  <div class="panel-footer text-center">Press Submit button after filling in details.</div>
</div>
</div>
</div>
</div>
